...
In [Chapter 4: Simpy Resource Enhancement (`CustomResource`, `Store`, `populate_store`)](04_simpy_resource_enhancement___customresource____store____populate_store___.qmd), we learned how to make sure our simulation records *which specific* resource (like Cubicle 1 vs. Cubicle 2) each patient is using. This gives us a detailed [Event Log](02_event_log_.qmd), the script of our process. We also have our stage map, the [Layout Configuration (`event_position_df`)](03_layout_configuration_event_position_df_.qmd).
